...
-   $stride: w\Big(1-\frac{p}{100}\Big), \text{cover\_span}=(n-1)\cdot \text{stride} + w$
-   $extension: \text{centre}\pm\tfrac{w}{2}\tfrac{p}{100}, \text{cover\_span}=n\cdot w + w\frac{p}{100} = w\Big(n+\frac{p}{100}\Big)$
